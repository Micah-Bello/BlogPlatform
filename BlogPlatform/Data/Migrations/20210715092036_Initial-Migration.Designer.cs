...
namespace BlogPlatform.Data.Migrations
{
    ...
    [Migration("20210715092036_Initial-Migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlogPlatform.Models.BlogUser", b =>
                {
            ...
            modelBuilder.Entity("BlogPlatform.Models.Blog", b =>
                {
                    b.HasOne("BlogPlatform.Models.BlogUser", "BlogUser")
                        .WithMany("Blogs")
            ...
            modelBuilder.Entity("BlogPlatform.Models.Comment", b =>
                {
                    ...
                    b.HasOne("BlogPlatform.Models.BlogUser", "Moderator")
                        .WithMany()
            ...
            modelBuilder.Entity("BlogPlatform.Models.Post", b =>
                {
                    b.HasOne("BlogPlatform.Models.Blog", "Blog")
                        .WithMany("Posts")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BlogPlatform.Models.BlogUser", null)
                        .WithMany()
